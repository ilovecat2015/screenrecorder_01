...
public class vodlocker {
    ...
    public static void main(String[] args) throws InterruptedException, FindFailed, URISyntaxException, IOException, AWTException {
        ...
        //Desktop.getDesktop().browse(new URI("http://vodlocker.com/fii6uymvn7yp"));
        //Debug.on(3);
        Screen s=new Screen();
        ...
        while(start){
            //Thread.sleep(1000);
               System.out.println("searching1");
                System.out.println((s.exists(new Pattern("vodlocker_proceed.png").exact())));
               System.out.println(new Pattern("vodlocker_proceed.png").getFileURL());
               System.out.println(s.exists(new Pattern("vodlocker_proceed.png").similar(0.95f)));
               System.out.println(new Pattern("vodlocker_proceed.png").getFileURL());

       

                if (s.exists(new Pattern("vodlocker_proceed.png").exact())!=null)
                {
                    System.out.println("vodlocker_proceed.png");
                    Debug.user("Match TVB: %s", s.find("vodlocker_proceed.png"));
                    s.find("vodlocker_proceed.png");
                    s.click("vodlocker_proceed.png");
                    start1=true;
                    start=false;
                }
 /*
      ...
      count=0;
        while(start1){
            ...
            Thread.sleep(2000);
               ...
               System.out.println((s.exists(new Pattern("vodlocker_play.png").exact())));
               System.out.println(new Pattern("vodlocker_play.png").getFileURL());

                if (s.exists( new Pattern("vodlocker_play.png"))!=null)
                {
                    System.out.println("find play button");
                    Debug.user("Match TVB: %s", s.find("vodlocker_play.png"));
                    s.find("vodlocker_play.png");
                    s.click("vodlocker_play.png");
                    //start2=true;
                    start1=false;
                }
                count++;
