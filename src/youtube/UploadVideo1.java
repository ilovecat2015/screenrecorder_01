...
import core.recorder.ScreenRecorder1;
...
public class UploadVideo1 {
   ...
   */
    ...
    try {
      ...
      youtube = new YouTube.Builder(HTTP_TRANSPORT, JSON_FACTORY, credential).setApplicationName(
        ...
        File file1=recConfig.getLoadFile();
                    ...
                    switch (cell.getCellType())
                    {
                        ...
                        case Cell.CELL_TYPE_STRING:
                            ...
                            if (st.startsWith("http")==true) {
                                ...
                                String videoID=uploadvideo1(videoFile1);
  ...
  public static String uploadvideo1(File videoFile) throws FileNotFoundException, IOException{
